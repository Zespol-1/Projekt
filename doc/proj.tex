...
\section{Poszukiwanie relacji i faktoryzacja w bazie}
	...
	\subsection{Faktoryzacja w bazie}
		...
		\begin{figure}[H]
			\begin{center}
				\includegraphics[width=9cm]{alg 5.png} \caption{Schemat blokowy algorytmu \ref{factor_alt}}
			\end{center}
		\end{figure}
...
\section{Eliminacja Gaussa w pierścieniu \(\mathbb{Z}_{p-1}\)}
	...
	\begin{figure}[H]
		\begin{center}
			\includegraphics[width=6cm]{alg 8.png} \caption{Schemat blokowy algorytmu \ref{extEuklid}}
		\end{center}
	\end{figure}
